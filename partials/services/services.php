...
if($services['services_content']['services_list']):
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center text-md-left mb-4">
                <h2 class="title" id="servicios-title"><?= $services['services_content']['title'] ?? ''; ?></h2>
            </div>
        </div>
        <?php foreach($services['services_content']['services_list'] as $item): ?>
